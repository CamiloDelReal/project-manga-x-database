package org.xapps.apps.mangaxdatabase.views.layoutmanagers
...
class SpannedGridLayoutManager(
    spanLookup: GridSpanLookup,
    private var columns: Int,
    private var cellAspectRatio: Float
) : RecyclerView.LayoutManager() {

    private var spanLookup: GridSpanLookup? = spanLookup
    ...
    override fun scrollToPosition(positionParam: Int) {
    ...
    private fun measureChildWithDecorationsAndMargin(child: View, widthSpecParam: Int, heightSpecParam: Int) {
        var widthSpec = widthSpecParam
        var heightSpec = heightSpecParam
